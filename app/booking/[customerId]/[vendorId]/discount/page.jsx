...
const CancelledOrdersPage = () => {
  ...
  const cancelledOrders = [
    ...
    },
    {
      ...
      description:
        "Aromatic basmati rice with tender chicken and exotic spices",
    },
    {
      id: "CO003",
          ...
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Flash Sale - Cancelled Orders
              </h1>
              <p className="text-gray-600 mt-2">
                Get amazing deals on freshly prepared meals - 25% off!
              </p>
            </div>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-orange-700">
                These cancelled orders are available at 25% discount. Order now
                before they're gone!
              </p>
            </div>
          </div>
        ...
        <div className="mt-12 bg-white rounded-lg p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
            <div>
              ...
              <p>
                All meals are freshly prepared and ready to be delivered
                immediately.
              </p>
            </div>
            <div>
              ...
              <p>
                Same high-quality food from your favorite restaurants at
                discounted prices.
              </p>
            </div>
            <div>
              ...
              <p>
                Once sold out, these specific meals won't be available again at
                this price.
              </p>
            </div>
          </div>
